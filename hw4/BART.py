...
trainer.save_model("./bart_jin_yong")
tokenizer.save_pretrained("./bart_jin_yong")
...
def generate_text_transformer(seed_text, max_length, model, tokenizer):
